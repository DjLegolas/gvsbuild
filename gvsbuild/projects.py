...
class Project_adwaita_icon_theme(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'adwaita-icon-theme',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/adwaita-icon-theme/3.38/adwaita-icon-theme-3.38.0.tar.xz',
...
class Project_dcv_color_primitives(Tarball, Meson):
    def __init__(self):
        Meson.__init__(self,
            ...
            archive_url = 'https://github.com/aws/dcv-color-primitives/archive/v0.1.17.tar.gz',
            archive_file_name = 'dcv-color-primitives-0.1.17.tar.gz',
            hash = '390305bc3e0eeecfcfcd2e0c6db803ce9c733fa9c1b645ff44b89eddce8d490f',
...
class Project_ffmpeg(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'ffmpeg',
            archive_url = 'https://www.ffmpeg.org/releases/ffmpeg-4.3.1.tar.xz',
...
class Project_gdk_pixbuf(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gdk-pixbuf',
            archive_url = 'http://ftp.acc.umu.se/pub/GNOME/sources/gdk-pixbuf/2.42/gdk-pixbuf-2.42.2.tar.xz',
...
class Project_glib_networking(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'glib-networking',
            archive_url = 'https://ftp.acc.umu.se/pub/gnome/sources/glib-networking/2.66/glib-networking-2.66.0.tar.xz',
            hash = 'c5d7be2437fdd196eebfb70c4517b96d3ba7ec13bd496318b8f02dea383e0099',
...
class Project_gstreamer(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gstreamer',
            archive_url = 'https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.18.2.tar.xz',
            hash = '66cdeb4f970c2e55932a2f427177d438fe2c55c0b6d29e80fda80263f2ae5446',
...
class Project_gst_plugins_base(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gst-plugins-base',
            archive_url = 'https://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-1.18.2.tar.xz',
            hash = 'dd04fb1f7826e2f6d9b4d66fc22f19cc6a47c301e13041f0ee3d7f65c89b05ac',
...
class Project_gst_plugins_good(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gst-plugins-good',
            archive_url = 'https://gstreamer.freedesktop.org/src/gst-plugins-good/gst-plugins-good-1.18.2.tar.xz',
            hash = 'f71752dde434d9ec55fa5e8d2e2a3be3fc6eb5b34f397b065f84aead25b449a4',
...
class Project_gst_plugins_bad(Tarball, Meson):
    def __init__(self):
        Project.__init__(self,
            'gst-plugins-bad',
            archive_url = 'https://gstreamer.freedesktop.org/src/gst-plugins-bad/gst-plugins-bad-1.18.2.tar.xz',
            hash = '8ad5822f1118fe46a19af54422b74e3a16d79a6800dcb173b49e199a496b341a',
...
class Project_openssl(Tarball, Project):
    def __init__(self):
        Project.__init__(self,
            'openssl',
            archive_url = 'https://www.openssl.org/source/openssl-1.1.1i.tar.gz',
...
class Project_protobuf(Tarball, CmakeProject):
    def __init__(self):
        Project.__init__(self,
            'protobuf',
            archive_url = 'https://github.com/protocolbuffers/protobuf/releases/download/v3.14.0/protobuf-cpp-3.14.0.tar.gz',
            hash = '50ec5a07c0c55d4ec536dd49021f2e194a26bfdbc531d03d1e9d4d3e27175659',
